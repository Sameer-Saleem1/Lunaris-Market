            ...
            >
              ...
              <div className="md:col-span-2 flex flex-wrap gap-3">
                <button
                  type="submit"
                  disabled={isUpdating}
                  className="rounded-full bg-white px-5 py-2 text-sm font-semibold text-[#0b0d13] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isUpdating && (
                    <svg
                ...
                <button
                  ...
                  onClick={closeProductModal}
                  disabled={isUpdating}
                  className="rounded-full border border-white/20 px-5 py-2 text-sm text-white disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
              </div>
